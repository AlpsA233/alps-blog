  ...
  return (
    <div className="card bg-pink-blue-animated relative max-w-5xl overflow-hidden">
      ...
      <div className="space-y-2 p-4 md:space-y-5">
        <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-white dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">{t('home_title')}</h1>
        <p className="text-xl font-bold leading-7 text-white dark:text-gray-400">
          {t('home_desc')}
        </p>
        <p className="text-2xl leading-7 text-white dark:text-gray-400">
          {t('home_temp_text')}
        </p>
      </div>
    </div>
