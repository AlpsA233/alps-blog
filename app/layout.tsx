...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      <head>
        <link rel="apple-touch-icon" sizes="76x76" href="/static/favicons/logo-sm.svg" />
        <link rel="icon" type="image/png" sizes="32x32" href="/static/favicons/logo-sm.svg" />
        <link rel="icon" type="image/png" sizes="16x16" href="/static/favicons/logo-sm.svg" />
